...
type IbWrapper interface {
	...
	TickOptionComputation(reqID int64, field int64, tickAttrib int64, impliedVol float64, delta float64, optPrice float64, pvDiviedn float64, gamma float64, vega float64, theta float64, undPrice float64)
